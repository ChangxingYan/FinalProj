...
public class DialogueSystem : MonoBehaviour
{
    ...
    public DialogueLine GetSub(int id)
    {
        // more readable, simple loop
        foreach (DialogueLine line in allDialogueEvents)
        {
    ...
    public DialogueLine GetCut(int id)
    {
        // more readable, simple loop
        foreach (DialogueLine line in allDialogueEvents)
        {
    ...
    void ReadExternalFile()
    {
        ...
        for (int i = 1; i < allLinesFromFile.Length; i++)
        {
            ...
            newLine.textBoxPosition = int.Parse(dialogueLineFromFile[5]);
            newLine.timeSub = float.Parse(dialogueLineFromFile[6]);
            newLine.timeCut = float.Parse(dialogueLineFromFile[7]);

            //this will be the name of the file asset
            newLine.imgAsset = dialogueLineFromFile[8];            
            ...
            newLine.audioAsset = dialogueLineFromFile[9].TrimEnd('\r', '\n', '\t');            
